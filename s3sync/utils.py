...
DRYRUN_LEVEL = 99
logging.addLevelName(DRYRUN_LEVEL, "DRYRUN")
def dryrun(self, message, *args, **kws):
	if self.isEnabledFor(DRYRUN_LEVEL):
		self._log(DRYRUN_LEVEL, message, args, **kws)
